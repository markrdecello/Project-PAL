...
Route::middleware('api')->post('/counselor/login', 'CounselorController@login');
Route::middleware('api')->post('/register', 'LoginController@register');
Route::middleware('api')->post('counselor/register', 'CounselorController@register');
Route::middleware('api')->post('/profile/update/{id}', 'LoginController@updateProfile');
Route::middleware('api')->post('counselor/profile/update/{id}', 'CounselorController@updateProfile');
Route::middleware('api')->get('/profile/{id}', 'LoginController@getProfile');
Route::middleware('api')->get('counselor/profile/{id}', 'CounselorController@getProfile');
